  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower your business with HR Management Application, your comprehensive solution for efficient, streamlined human resource management."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower your business with HR Management Application, your comprehensive solution for efficient, streamlined human resource management.`}
            </Text>
            <Box
